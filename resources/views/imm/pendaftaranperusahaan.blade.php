                ...
                <div class="informasi-alamat">
                    <table>
                        <tr>
                            ...
                            <td><input type="text" placeholder="Negara" id="negara" name="negara" required />
                            </td>
                        </tr>
                        <tr>
                            <td><span class="input-icon"><i class="fas fa-map-marker-alt"></i></span></td>
                            <td><input type="text" placeholder="Provinsi" id="provinsi" name="provinsi" required />
                            </td>
                        </tr>
                        <tr>
                            <td><span class="input-icon"><i class="fas fa-map-marker-alt"></i></span></td>
                            <td><input type="text" placeholder="Kabupaten" id="kabupaten" name="kabupaten"
                                    required /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2"><button class="btn btn-primary" type="submit" id="simpanBtn">Simpan
                                    Data</button></td>
                        </tr>
                    </table>
                </div>
