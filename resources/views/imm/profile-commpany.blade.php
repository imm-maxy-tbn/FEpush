                ...
                <div class="row mt-5 d-flex justify-content-center">
                    ...
                    <div class="col-12 col-md-10">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email" value="{{ $user->email }}" readonly data-toggle="modal" data-target="#emailModal">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Password</label>
                            <input type="password" name="password" class="form-control" id="exampleInputPassword1" placeholder="Password" value="{{$user->password}}" readonly data-toggle="modal" data-target="#passwordModal">
                        </div>
                        <div class="mb-3">
