...
<div class="container propil">
    ...
    <div class="container">
        <form method="POST" action="{{ route('profile-commpany.update', ['id' => $company->id]) }}" id="updateCompanyForm">
            @csrf
            @method('PUT')
            <section> 
                    ...
                    <div class="col-12 col-md-10">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" name="nama_depan" id="nama-depan" class="form-control" placeholder="First Name" value="{{ $user->nama_depan }}">
                            </div>
                        </div>
                        <div class="mb-3">
    ...
    <section>
        <div class="row my-3 d-flex justify-content-center align-items-center">
            <button type="submit" form="updateCompanyForm" class="btn btn-outline-secondary">
