    ...
    <body>
        ...
        <div class="container" style="padding-top: 120px">
            <a href="detailbiaya">
                <h4 class=" d-flex align-items-center"><strong style="font-size: 40px;">
                        <</strong> Tambah penggunaan dana</h4>
            </a>
        ...
        <div class="container mt-5">
            <div class="row mt-4">
                ...
                <div class="col-8"> <input type="date" name=""></div>
            </div>
            <div class="row mt-4">
                <div class="col-3">
                    <h5>Jumlah Biaya</h5>
                </div>
                <div class="col-8"> <input type="number" name="" placeholder="cth. Rp 100.000"></div>
            </div>
            <div class="row mt-4">
                <div class="col-3">
                    <h5>Keterangan</h5>
                ...
                <div class="col-8">
                    <textarea name="" id="" placeholder="cth. Pembelian karung beras bekas (5 lusin)" cols="60"
                        rows="7"></textarea>
                </div>
            </div>
            <div class="row mt-4">
                ...
                <div class="modal-content shadow ">
                    ...
                    <div class="modal-body">
                        ...
                        <div class=" btnn">   <button type="button" class="btn btn-keluar" data-dismiss="modal">Belum, cek kembali</button>
                           <a href="/tambahpenggunaandana"><button type="submit"   class="btn btn-masuk"  id="confirmUpdate">Ya, sudah benar</button></a> 
