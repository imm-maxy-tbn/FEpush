...
<body>
    <div class="container" style="padding-top: 120px">
        <a href="homepage">
            <h4 class=" d-flex align-items-center"><strong style="font-size: 40px;"><</strong> Kelola Pengeluaran</h4>
        </a>
    ...
    <div class="container my-4 d-flex justify-content-between align-items-center">
        ...
        <div class="form-inline">
            <input type="text" id="search-input" class="form-control" placeholder="Cari nama proyek anda">
        </div>
    </div>
