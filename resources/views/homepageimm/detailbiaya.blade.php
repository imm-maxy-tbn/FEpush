...
@section('content')
    <div class="container" style="padding-top: 120px">
        <div class="row d-flex justify-content-between">
            <a href="{{ route('kelola-pengeluaran') }}">
                <h4 class=" d-flex align-items-center"><strong style="font-size: 40px;">&lt;</strong> Detail penggunaan biaya
                    proyek {{ $project->nama }}</h4>
            </a>
    ...
    <div class="container">
        ...
        <table class="table tabel mt-4 text-center border">
            <thead>
                <tr>
                    <th>Tanggal</th>
                    <th>Jumlah Biaya</th>
