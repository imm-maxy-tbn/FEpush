                ...
                <div class="container mt-5">
                        ...
                        @if ($indicator->level == 1)
                            <div class="mt-3 d-flex align-items-center level-1-indicator" style="gap: 15px">
                                <label for="indicator-{{ $indicator->id }}">
                                    <input type="checkbox" class="indicator-checkbox" id="indicator-{{ $indicator->id }}" value="{{ $indicator->id }}">
                    ...
                    @foreach ($sdg->indicators as $indicator)
                        @if ($indicator->level == 2)
                            <div class="sub-container" id="sub-container-{{ $indicator->parent_indicator_id }}" data-parent="{{ $indicator->parent_indicator_id }}" style="display: none; margin-top: 10px;">
