...
<script>
    $(document).ready(function() {
        ...
        $('#next-to-indicator-section').on('click', function() {
            // Sembunyikan semua deskripsi indikator terlebih dahulu
            $('.goal-description').hide();

            // Dapatkan semua checkbox SDG yang dipilih
            var selectedSdgs = $('.sdg-checkbox:checked');

            // Tampilkan deskripsi indikator hanya untuk SDG yang dipilih
            selectedSdgs.each(function() {
                var sdgId = $(this).val();
                $('#goal' + sdgId + '-description').show();
            });

            // Pindah ke section indikator
            $('#sdg-section').hide();
