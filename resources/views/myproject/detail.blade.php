...
<head>
    ...
    <style>
        ...
        .input-container {
            display: flex;
            flex-direction: column; /* Mengatur elemen menjadi kolom (atas-bawah) */
            align-items: flex-start; /* Mengatur elemen untuk rata kiri */
            gap: 10px; /* Memberi jarak antara elemen */
            margin: 0;
        }
        ...
        .input-container .right {
            margin: 0;
            text-align: left; /* Menyelaraskan teks tombol ke kiri */
            width: 100%; /* Memastikan tombol memiliki lebar 100% */
        }
